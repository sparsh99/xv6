...
runcmd(struct cmd *cmd)
{
  ...
  case EXEC:
    ...
    printf1(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      71:	6a 02                	push   $0x2
      73:	e8 d4 0f 00 00       	call   104c <printf1>
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      c4:	6a 02                	push   $0x2
      c6:	e8 81 0f 00 00       	call   104c <printf1>
...
getcmd(char *buf, int nbuf)
{
  ...
  printf1(2, "$ ");
     ...
     259:	6a 02                	push   $0x2
     25b:	e8 ec 0d 00 00       	call   104c <printf1>
...
panic(char *s)
{
  ...
  printf1(2, "%s\n", s);
     ...
     3ad:	6a 02                	push   $0x2
     3af:	e8 98 0c 00 00       	call   104c <printf1>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read1(0, &c, 1);
     ...
     d9e:	50                   	push   %eax
     d9f:	6a 00                	push   $0x0
     da1:	e8 47 01 00 00       	call   eed <read1>
...
putc(int fd, char c)
{
  ...
  write1(fd, &c, 1);
     ...
     f8d:	e8 63 ff ff ff       	call   ef5 <write1>
...
printf1(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1069:	e9 59 01 00 00       	jmp    11c7 <printf1+0x17b>
    c = fmt[i] & 0xff;
    ...
    1088:	75 2c                	jne    10b6 <printf1+0x6a>
      if(c == '%'){
    108a:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    108e:	75 0c                	jne    109c <printf1+0x50>
        state = '%';
    1090:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    1097:	e9 27 01 00 00       	jmp    11c3 <printf1+0x177>
      } else {
        putc(fd, c);
    ...
    10b1:	e9 0d 01 00 00       	jmp    11c3 <printf1+0x177>
      }
    } else if(state == '%'){
    10b6:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    10ba:	0f 85 03 01 00 00    	jne    11c3 <printf1+0x177>
      if(c == 'd'){
    10c0:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    10c4:	75 1e                	jne    10e4 <printf1+0x98>
        printint(fd, *ap, 10, 1);
    ...
    10df:	e9 d8 00 00 00       	jmp    11bc <printf1+0x170>
      } else if(c == 'x' || c == 'p'){
    10e4:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    10e8:	74 06                	je     10f0 <printf1+0xa4>
    10ea:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    10ee:	75 1e                	jne    110e <printf1+0xc2>
        printint(fd, *ap, 16, 0);
    ...
    1109:	e9 ae 00 00 00       	jmp    11bc <printf1+0x170>
      } else if(c == 's'){
    110e:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    1112:	75 43                	jne    1157 <printf1+0x10b>
        s = (char*)*ap;
    ...
    1124:	75 25                	jne    114b <printf1+0xff>
          s = "(null)";
    1126:	c7 45 f4 f4 14 00 00 	movl   $0x14f4,-0xc(%ebp)
        while(*s != 0){
    112d:	eb 1c                	jmp    114b <printf1+0xff>
          putc(fd, *s);
    ...
    1153:	75 da                	jne    112f <printf1+0xe3>
    1155:	eb 65                	jmp    11bc <printf1+0x170>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    1157:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    115b:	75 1d                	jne    117a <printf1+0x12e>
        putc(fd, *ap);
    ...
    1178:	eb 42                	jmp    11bc <printf1+0x170>
      } else if(c == '%'){
    117a:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    117e:	75 17                	jne    1197 <printf1+0x14b>
        putc(fd, c);
    ...
    1195:	eb 25                	jmp    11bc <printf1+0x170>
      } else {
  ...
  for(i = 0; fmt[i]; i++){
    ...
    11d4:	0f 85 94 fe ff ff    	jne    106e <printf1+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
morecore(uint nu)
{
  ...
  p = sbrk1(nu * sizeof(Header));
    ...
    12de:	50                   	push   %eax
    12df:	e8 79 fc ff ff       	call   f5d <sbrk1>
